...
<div class="container-fluid" id="container-wrapper">
                ...
                <div class="card-body">
                    <table class="table table-striped">
                        ...
                        <tr>
                            ...
                            <td width="2%">:</td>
                            <td>{{$user->penyuluh->jabatan}}</td>
                        </tr>
                        <tr>
                            <td width="24%">Tempat, tanggal lahir</td>
                            <td width="2%">:</td>
                            <td>{{$user->penyuluh->tempat_lahir}}, {{Carbon\carbon::parse($user->penyuluh->tanggal_lahir)->format('d - m - Y')}}</td>
                        </tr>
                        <tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('userPenyuluh.profil.update',Auth::user()->id)}}" method="POST">
                @csrf
                @method('PUT')
