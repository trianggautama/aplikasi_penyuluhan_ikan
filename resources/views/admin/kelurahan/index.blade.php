                        ...
                        <table class="table align-items-center table-flush" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('userAdmin.kelurahan.destroy',$d->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-warning"
                                                href="{{Route('userAdmin.kelurahan.edit',$d->id)}}"><i
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{Route('userAdmin.kelurahan.store')}}" method="POST">
                    @csrf
