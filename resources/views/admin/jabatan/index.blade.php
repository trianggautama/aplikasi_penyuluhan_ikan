                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-flush" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <form action="{{ route('userAdmin.jabatan.destroy','1') }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-warning" href="{{Route('userAdmin.jabatan.edit','1')}}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
