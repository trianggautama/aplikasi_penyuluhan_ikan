                        ...
                        <div class="table-responsive p-3">
                            <table class="table align-items-center table-flush" id="dataTable">
                                ...
                                <tr>
                                    ...
                                    <td>-</td>
                                    <td>
                                        <form action="{{ route('userAdmin.kecamatan.destroy','1') }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <a class="btn btn-sm btn-warning" href="{{Route('userAdmin.kecamatan.edit','1')}}"><i class="fa fa-edit"></i>&nbsp;Edit</a>
